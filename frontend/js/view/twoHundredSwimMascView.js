...
function render (athletes){
    ...
    const placeholderImages = [
        '../frontend/rsc/img/200m swim/danion_loader.png',
        '../frontend/rsc/img/200m swim/Screenshot 2024-08-08 at 00.44.08.png',
        '../frontend/rsc/img/200m swim/Screenshot 2024-08-08 at 00.44.50.png',
        '../frontend/rsc/img/200m swim/Screenshot 2024-08-08 at 00.45.28.png',
        '../frontend/rsc/img/200m swim/Screenshot 2024-08-08 at 00.46.01.png',
        '../frontend/rsc/img/100m-swim-women/mette_jacobsen.png',
        '../frontend/rsc/img/100m-swim-women/sandra_volker.png',
        '../frontend/rsc/img/100m-swim/ricardo_busquets.png'
    ];
    ...
    heading.id = 'heading';
    heading.innerHTML = '<h1>200 Meters Freestyle Men</h1>';
    ...
    for (let i = 1; i <= 8; i++) {
        ...
        box.dataset.lapsCompleted = 0;
  
        const img = document.createElement('img');
        img.src = '../frontend/rsc/img/swimmer.gif';
    ...
    function move(target, id) {
        ...
        if (direction === 'right') {
            ...
            if (currentPosition + targetWidth >= containerWidth) {
                ...
                img.src = '../frontend/rsc/img/swimmer-rotate.gif';
            }
        } else {
            target.style.left = currentPosition - 1 + "px";
            if (currentPosition <= 0) {
                target.dataset.direction = 'right';
                target.dataset.lapsCompleted = parseInt(target.dataset.lapsCompleted, 10) + 1;
                const lapsCompleted = parseInt(target.dataset.lapsCompleted, 10);
                if (lapsCompleted >= 2) {
                    clearInterval(id);
                    const img = target.querySelector("img");
    ...
    startButton.addEventListener("click", () => {
        ...
        Array.from(boxes).forEach(box => {
            ...
            box.dataset.lapsCompleted = 0; // Initialize laps completed
    ...
    resetButton.addEventListener("click", () => {
        ...
        Array.from(boxes).forEach(box => {
            ...
            box.dataset.lapsCompleted = 0; // Reset laps completed
