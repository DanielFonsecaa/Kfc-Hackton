...
function render (athletes){
    ...
    const placeholderImages = [
      '../frontend/rsc/img/100m-swim/Aleksandr_Popov.png',
      '../frontend/rsc/img/100m-swim/fernando_scherer.png',
      '../frontend/rsc/img/100m-swim/francisco_sanchez.png',
      '../frontend/rsc/img/100m-swim/Gary_hall_jr.png',
      '../frontend/rsc/img/100m-swim/gustavo_borges.png',
      '../frontend/rsc/img/100m-swim/pavlo_khnykin.png',
      '../frontend/rsc/img/100m-swim/pieter_van_den_hoogenband.png',
    ...
    heading.id = 'heading';
    heading.innerHTML = '<h1>100 Meters Freestyle Men</h1>';
